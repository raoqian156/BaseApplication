...
/**
 * Log工具,类似android.util.Log。 tag自动产生,格式: * customTagPrefix:className.methodName(Line:lineNumber), * customTagPrefix为空时只输出:className.methodName(Line:lineNumber)。 * http://blog.csdn.net/finddreams
 */
public class LogUtil {
    ...
    //    SD卡中的根目录
    private static final String PATH_LOG_INFO = ROOT;// TODO: 2018/5/18
