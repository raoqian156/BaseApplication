...
class LoggerPrinter implements Printer {
    ...
    private static final String DEFAULT_TAG = "LoggerPrinter";
    ...
    public LoggerPrinter(String allTag) {
        init(allTag == null ? DEFAULT_TAG : allTag);
    }

    /**
     * It is used to change the tag
     *
     * @param tag is the given string which will be used in Logger2
     */
    @Override
    ...
    public synchronized void log(int priority, String tag, String message, Throwable throwable) {
        ...
        if (throwable != null && message != null) {
            Log.e("LoggerPrinter.LINE", "224 ----------\n " + message);
            message += " : " + Helper.getStackTraceString(throwable);
        }
        if (throwable != null && message == null) {
            message = Helper.getStackTraceString(throwable);
            Log.e("LoggerPrinter.LINE", "230 ----------null \n" + message);
        }
        if (message == null) {
    ...
    private void logHeaderContent(int logType, String tag, int methodCount) {
        ...
        for (int i = methodCount; i > 0; i--) {
            ...
            builder2.append(trace[stackIndex].getFileName())
                    .append(":")
                    .append(trace[stackIndex].getLineNumber());
            TLog.error("LoggerPrinter", "logHeaderContent.- builder2.toString()-> " + builder2.toString());
            TLog.error("LoggerPrinter", "logHeaderContent.--> " + (trace[stackIndex].getFileName() + ":" + trace[stackIndex].getLineNumber()));
            TLog.error("LoggerPrinter", "logHeaderContent.- builder.toString()-> " + builder.toString());
            TLog.error("LoggerPrinter", "logHeaderContent.- builder.trace.toString()-> " + trace[stackIndex].toString());
    ...
    private int getStackOffset(StackTraceElement[] trace) {
        for (int i = MIN_STACK_OFFSET; i < trace.length; i++) {
            ...
            if (!name.equals(LoggerPrinter.class.getName()) && !name.equals(Logger2.class.getName())) {
                return --i;
            }
        }
        return -1;
