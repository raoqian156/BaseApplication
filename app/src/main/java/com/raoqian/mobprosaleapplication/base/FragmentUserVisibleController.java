...
public class FragmentUserVisibleController {
    ...
    public FragmentUserVisibleController(BaseFragment fragment, UserVisibleCallback userVisibleCallback) {
    ...
    public void resume() {
        ...
        if (fragment.getUserVisibleHint()) {
            userVisibleCallback.onVisibleToUserChanged(true, true, isFirstTimeShow);
            if (isFirstTimeShow) {
    ...
    public void pause() {
        ...
        if (fragment.getUserVisibleHint()) {
            userVisibleCallback.onVisibleToUserChanged(false, true, false);
    ...
    public void setUserVisibleHint(boolean isVisibleToUser) {
        ...
        if (fragment.isResumed()) {
            if (isVisibleToUser && isFirstTimeShow) {
                userVisibleCallback.onVisibleToUserChanged(true, false, true);
                isFirstTimeShow = false;
            } else {
                userVisibleCallback.onVisibleToUserChanged(isVisibleToUser, false, false);
            }
...
//    }
    ...
    public interface UserVisibleCallback {
        ...
        void onVisibleToUserChanged(boolean isVisibleToUser, boolean invokeInResumeOrPause, boolean isFirstTimeShow);
    }

    public interface OnUserVisibleListener {
        boolean onVisibleToUserChanged(boolean isVisibleToUser, boolean invokeInResumeOrPause);
    }
}
